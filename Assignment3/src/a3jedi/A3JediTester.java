...
public class A3JediTester {
	...
	public static void main(String[] args) {
		...
		ip = iter.next();
		if (!pixel_compare(ip, cyan)) {
			System.out.println("Expected 7th pixel from zigzag iterator to be cyan");
		}
		ip = iter.next();
		if (!pixel_compare(ip, cyan)) {
			System.out.println("Expected 8th pixel from zigzag iterator to be cyan");
		}
		ip = iter.next();
		if (!pixel_compare(ip, cyan)) {
			System.out.println("Expected 9th pixel from zigzag iterator to be cyan");
		}
