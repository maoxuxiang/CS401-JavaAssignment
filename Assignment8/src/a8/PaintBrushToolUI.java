...
public class PaintBrushToolUI extends JPanel implements ChangeListener {
	...
	public PaintBrushToolUI(double[] color) {
		...
		size_slider = new JSlider(0,25,1);
	...
	public void changeColor() {
		...
		red_slider.setValue((int)(Color[0]*100));
		green_slider.setValue((int)(Color[1]*100));
		blue_slider.setValue((int)(Color[2]*100));
